...
class BeastPostPlugin {
    ...
    public function render_meta_box($post) {
        ...
        <div id="beastpost-container">
            ...
            <p style="display: flex; justify-content: space-between; gap: 10px;">
                ...
                <button type="button" id="beastpost-download-button" class="button button-secondary" style="display: none;">Download Post</button>
            </p>
        </div>
        <?php
    }
    ...
    public function ajax_create_post() {
        ...
        if ($mode === 'content') {
                        ...
                        "json_schema" => array(
                            ...
                            "schema" => array(
                                ...
                                "properties" => array(
                                    "title" => array(
                                        "type" => "string",
                                        "description" => "The title of the blog post without any HTML tags"
                                    ),
                                    "content" => array(
                                        "type" => "string",
                                ...
                                "required" => array("title", "content", "seo_link", "image_description"),
            ...
            // Cache the successful response for content generation
            if ($mode === 'content') {
